...
@Component
public class InMemoryProhibitionContentRepository implements ProhibitionContentRepository {

  private static final List<ProhibitionDescription> prohibitionDescriptions =
      List.of(
  ...
  public Flux<ProhibitionDescription> findAll() {
    return Flux.fromIterable(prohibitionDescriptions);
  }
}
