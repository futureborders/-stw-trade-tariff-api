...
public class TradeTypeStringToEnumConverter implements Converter<String, TradeType> {

  @Override
  public TradeType convert(String tradeType) {
    try {
      return TradeType.valueOf(tradeType.toUpperCase());
    } catch (IllegalArgumentException e) {
      throw new EnumNotFoundException(TradeType.class, tradeType);
    }
  }
}
