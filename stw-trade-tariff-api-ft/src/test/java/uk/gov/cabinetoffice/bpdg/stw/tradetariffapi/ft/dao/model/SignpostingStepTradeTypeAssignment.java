...
@AllArgsConstructor
@Entity
@Table(name = "signposting_step_trade_type_assignment")
@TypeDef(
  name = "pgsql_enum",
  typeClass = PostgresSQLEnumType.class
)
public class SignpostingStepTradeTypeAssignment {
  ...
  @Column(name = "blanket_apply")
  @Builder.Default private boolean blanketApply = false;
}
